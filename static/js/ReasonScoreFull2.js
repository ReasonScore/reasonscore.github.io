...
(function () {
    ...
    onload1 = function () {
        ...
        if (window.location.hostname === "localhost" && window.location.pathname.length > 1 ) { //If it is the home page on local host then there is no need to load therse scripts as they ate included by React
